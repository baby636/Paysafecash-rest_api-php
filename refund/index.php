...
// create new CashRefund Controller
$pscrefund = new PaysafecardCashRefundController($config['psc_key'], $config['environment']);
if ($config['logging']) {
...
if (isset($_POST["action"])) {
    ...
    if ($action == "captureRefund") {
        ...
        // direct refund
        $response = $pscrefund->captureRefund($payment_id, $amount, $currency, $clientid, $customer_mail, $correlation_id);
        if ($config['logging']) {
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form class="navbar-form navbar-right" method="POST">
                            ...
                            <div class="form-group" style="padding: 10px">
                                ...
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" name="customer_mail" class="form-control" value=""></td>
                                    </tr>
                                    <tr>
                                        <td>Client ID:</td>
                            ...
                            <button type="submit" name="action" value="captureRefund" class="btn btn-success">Capturing Refund</button>
                        </form>
                    </div>
                </div>
